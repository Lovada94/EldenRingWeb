...
/* Controlador de autenticación: registro, login y verificación de token */
class Auth extends ResourceController
{
    ...
    public function register()
    {
        ...
        /* Validar los campos obligatorios del formulario de registro */
        ...
        /* Comprobar que el email y el username no estén ya registrados */
    ...
    public function login()
    {
        ...
        /* Buscar el usuario por email o por username según lo que se haya enviado */
        if (!empty($data['email'])) {
        ...
        /* Datos del usuario que se devuelven al frontend (sin contraseña) */
        $userResponse = [
            'id_user'  => $user['id_user'],
            'name'     => $user['name'],
            'email'    => $user['email'],
    ...
    /* GET /test-auth — endpoint de prueba para verificar que el token es válido */
