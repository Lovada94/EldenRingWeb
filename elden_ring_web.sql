...
COLLATE utf8mb4_unicode_ci;
ALTER TABLE team
ADD COLUMN ash1 VARCHAR(50) NULL AFTER bolt2,
ADD COLUMN ash2 VARCHAR(50) NULL AFTER ash1,
ADD COLUMN ash3 VARCHAR(50) NULL AFTER ash2;
ALTER TABLE team ADD COLUMN name VARCHAR(100) DEFAULT 'Equipo' NOT NULL AFTER id_user;
ALTER TABLE team ADD COLUMN is_active TINYINT(1) DEFAULT 0 AFTER name;
ALTER TABLE team
ADD COLUMN spell1 VARCHAR(50) NULL AFTER item10,
ADD COLUMN spell2 VARCHAR(50) NULL AFTER spell1,
ADD COLUMN spell3 VARCHAR(50) NULL AFTER spell2,
ADD COLUMN spell4 VARCHAR(50) NULL AFTER spell3,
ADD COLUMN spell5 VARCHAR(50) NULL AFTER spell4;
